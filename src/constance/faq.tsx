export const FAQ = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: (
          <p>
            您可透過網站底部連結進行檔期詢問、費用查詢與預約。訂單確認後，每套服裝需預繳 50%
            訂金；如取消訂單，訂金將不予退還。
          </p>
        )
      },
      ...
      },
      {
        ...
        answer: (
          <>
            <p>我們提供限量試穿服務，歡迎有租借意願的客人洽詢現場工作人員協助。</p>
            <p>為維持服務品質與流程順暢，恕不提供純試穿服務，敬請見諒。</p>
            <p>繁忙期間（如萬聖節、春酒旺季）將暫停現場試穿服務。</p>
            <p>部分高價或特殊款式試穿需收取 NT$100 意向金，成功租借可全額折抵。</p>
          </>
        )
      },
      {
        ...
        answer: (
          <p>
            我們可提供簡易調整（如肩帶長度、腰帶綁法），無法進行大幅修改。若有特殊需求，請提前告知。
          </p>
        )
      },
      {
        question: '6：租借時間多久？',
        answer: <p>一般租期為 3 天，如需延長請提前聯繫。延租每一天加收原租金的 30%。</p>
      },
      {
        question: '7：可以提前預約嗎？最晚什麼時候預約？',
        answer: (
          <p>
            建議提早預約，特別是熱門時段（如萬聖節、聖誕節、尾牙、春酒等），活動前 1 個月預約為佳。
          </p>
        )
      },
      {
        ...
        answer: (
          <>
            ...
            <p>
              <strong>部分取消：</strong> 因人為因素取消部分商品，將扣除該商品訂金（租金 50%）。
            </p>
            <p>
              <strong>整筆取消：</strong> 因人為因素取消整筆訂單，所有訂金不予退還。
            </p>
            <p>
              <strong>未取件視同取消：</strong>{' '}
              若已逾取件時間未到場，系統將視為取消，不另行通知，訂金不退還。
            </p>
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: (
          <p>
            是的。每件服裝道具皆需收取押金，押金為租金的 2 倍，或提供{' '}
            <strong>有效證件（身分證／駕照／健保卡）</strong>{' '}
      ...
      },
      {
        ...
        answer: <p>可以。如有需求，請於付款時提供 公司抬頭與統編，我們將開立收據或發票。</p>
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        answer: (
          <p>
            您無需自行清洗，我們將進行專業清潔。但請保持道具基本清潔與乾燥，避免嚴重污損或潮濕。
          </p>
        )
      },
      {
        ...
        answer: (
          <>
            ...
            <p>可將商品送至專業洗衣／修補店處理後再歸還，避免爭議與額外費用。</p>
            <p>※ 若因污損或破損影響後續使用，將比照逾期費用計算至修復完成為止。</p>
            <p>
              <strong>方式二：由我們代處理</strong>
            </p>
            <p>若無法自行處理，我們可協助送洗／修補，所有費用由租借人負擔，恕不接受異議。</p>
          </>
        )
      },
      {
      ...
      },
      {
        ...
        answer: <p>將依《刑法第335條》普通侵占罪處理，並協請警方介入。同時求償營業損失。</p>
      },
      {
        question: '16：道具服有什麼需要特別注意？',
        answer: (
          <>
            <p>所有商品未經同意不得改造或破壞，亦禁止使用膠類（如雙面膠、泡棉膠）與釘書針。</p>
            <p>
              表演／道具服多為特殊材質，遇水、淋雨或流汗易產生退色或染色。請務必於使用完後立即晾乾通風。
            </p>
            <p>
              潮濕狀態下請勿將深淺色服裝混放，避免染色。若因未妥善處理導致服裝損壞或他人物品染色，須依情況賠償，本店概不負責。
            </p>
          </>
        )
      }
